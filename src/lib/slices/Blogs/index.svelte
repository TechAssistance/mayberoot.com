<script>
	...
	/** @type {import("@prismicio/client").Content.BlogsSlice} */
	export let slice;
	/** @type {import("@prismicio/client").Content.BlogDocument[]} */
		...
		{#each caseStudies as caseStudy, index}
			...
			>
				<div class="col-span-1 flex flex-col justify-center gap-4">
					...
					>
						Read <PrismicText field={caseStudy.data.title} /> case study
					</PrismicLink>
				</div>
